 ...
 */
declare const useReferenceArrayFieldController: ({ basePath, filter, page: initialPage, perPage: initialPerPage, record, reference, resource, sort: initialSort, source, }: Option) => ListControllerProps<Record>;
