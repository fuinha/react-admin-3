...
var SaveButton = function (props) {
    ...
    return (react_1.default.createElement(Button_1.default, __assign({ className: classnames_1.default(classes.button, className), variant: variant, type: type, onClick: handleClick, color: saving ? 'default' : 'primary', "aria-label": displayedLabel, disabled: disabled || pristine }, Button_2.sanitizeButtonRestProps(rest)),
