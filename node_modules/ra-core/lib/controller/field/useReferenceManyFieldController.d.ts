 ...
 */
declare const useReferenceManyFieldController: ({ resource, reference, record, target, filter, source, basePath, page: initialPage, perPage: initialPerPage, sort: initialSort, }: Options) => ListControllerProps<Record>;
